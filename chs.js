...
var cnItems = {
    ...
    "Erase save": "删除存档",
    "Export Save": "导出存档",
    "Faster ticks: spend your offline gains to accelerate game speed.": "更快的tick：花费你的离线收益来加快游戏速度。",
    ...
    "Synthesis": "合成",
    "The Incremental Table of Elements ": "增量元素表",
    "Tier 1: ": "第 1 级：",
    "Total": "共计",
    "Upgrades ": "升级 ",
    "Reactions ": "反应 ",
    ...
    "Periodic Table ": "元素周期表",
    "Reactions": "反应",
    "is a subatomic particle, symbol p, with a positive electric charge of +1e elementary charge and mass slightly less than that of a neutron. Protons and neutrons, each with mass approximately one atomic mass unit, are collectively referred to as \"nucleons\". One or more protons are present in the nucleus of every atom. The number of protons in the nucleus is the defining property of an element, and is referred to as the atomic number. Since each element has a unique number of protons, each element has its own unique atomic number.": "是一种亚原子粒子，符号p，带有+1e基本电荷的正电荷，质量略小于中子。 质子和中子的质量约为一个原子质量单位，统称为“核子”。 每个原子的原子核中都存在一个或多个质子。 原子核中的质子数是元素的定义属性，称为原子序数。 由于每个元素都有唯一的质子数，因此每个元素都有自己唯一的原子序数。",
    "  Electron affinity ": "电子亲和力",
    "  Ions ": "   离子",
    "electron affinity": "电子亲和力",
    "Gather 10.000 p.\n": "收集 10,000 p。\n",
    "Generate 10.000 H-.\n": "生成 10.000 H-。\n",
    "In chemistry and atomic physics, the": "在化学和原子物理学中，",
    "of an atom or molecule is defined as the amount of energy released when an electron is added to a neutral atom or molecule in the gaseous state to form a negative ion.": "原子或分子的能量定义为当电子添加到气态中性原子或分子以形成负离子时释放的能量。",
    "proton": "质子",
    "Proton": "质子",
    "Protons (p) can be produced or consumed ionization.": "质子（p）可以被电离产生或消耗。",
    "Use electron affinity to produce ions, adding electrons to atoms.": "利用电子亲和力产生离子，将电子添加到原子中。",
    "and atomic number 8. It is a member of the chalcogen group on the periodic table and is a highly reactive nonmetal and oxidizing agent that readily forms compounds (notably oxides) with most elements. By mass, oxygen is the third-most abundant element in the universe, after hydrogen and helium. At standard temperature and pressure, two atoms of the element bind to form dioxygen, a colorless and odorless diatomic gas with the formula O": "原子序数为8。它是元素周期表中硫族元素的成员，是一种高反应性非金属和氧化剂，很容易与大多数元素形成化合物（特别是氧化物）。 按质量计算，氧是宇宙中第三丰富的元素，仅次于氢和氦。 在标准温度和压力下，该元素的两个原子结合形成双氧，一种无色无味的双原子气体，分子式为 O",
    ". Diatomic oxygen gas constitutes 20.8% of the Earth's atmosphere. Oxygen is the most abundant element by mass in the Earth's crust as part of oxide compounds such as silicon dioxide, making up almost half of the crust's mass.": "。 双原子氧气占地球大气的20.8%。 氧是地壳中质量最丰富的元素，是二氧化硅等氧化物的一部分，几乎占地壳质量的一半。",
    "(from Greek ἄλλος (allos), meaning \"other\", and τρόπος (tropos), meaning \"manner, form\") is the property of some chemical elements to exist in two or more different forms, in the same physical state, known as allotropes of these elements. Allotropes are different structural modifications of an element; the atoms of the element are bonded together in a different manner.": "（来自希腊语ἄλλος（allos），意思是“其他”，和τρόπος（tropos），意思是“方式，形式”）是某些化学元素以两种或多种不同形式存在的属性，处于相同的物理状态，称为这些元素的同素异形体。 同素异形体是元素的不同结构修饰； 元素的原子以不同的方式结合在一起。",
    "  Allotrope ": "   同素异形体",
    "  Free radical ": "   自由基",
    "  Unstable compound ": "   不稳定的化合物",
    "Allotrope": "同素异形体",
    "allotropism": "同素异形性",
    "Allotropy": "同素异形体",
    "Arsenic": "砷",
    ...
    "Carbon": "碳",
    "Chlorine": "氯",
    "Different molecules of the same atom.": "同一原子的不同分子。",
    "Fluorine": "氟",
    "Gallium": "镓",
    "Gather 100.000 O.\n": "收集 100.000 O。\n",
    "Germanium": "锗",
    "Increase your Oxygen generation and randomly produce an unstable compound.\n": "增加氧气生成量并随机产生不稳定的化合物。\n",
    "Increase your Oxygen production and randomly generate an allotrope.\n": "增加氧气产量并随机生成同素异形体。\n",
    "is a chemical element with symbol": "是一种带有符号的化学元素",
    "Lithium": "锂",
    "Nitrogen": "氮",
    "Oxygen": "氧",
    "Oxygen introduces new isotopes, properties and behaviours than Hydrogen. Use O to buy Oxygen generators and upgrades.": "与氢相比，氧引入了新的同位素、特性和行为。 使用 O 购买氧气发生器并升级。",
    "Phosphorus": "磷",
    "Sulfur": "硫",
    ") is an atom, molecule, or ion that has unpaired valence electrons. With some exceptions, these unpaired electrons make free radicals highly chemically reactive towards other substances, or even towards themselves: their molecules will often spontaneously dimerize or polymerize if they come in contact with each other. Most radicals are reasonably stable only at very low concentrations in inert media or in a vacuum.": ") 是具有不成对价电子的原子、分子或离子。 除了一些例外，这些不成对的电子使自由基对其他物质甚至自身产生高度化学反应：如果它们的分子彼此接触，它们通常会自发二聚或聚合。 大多数自由基只有在惰性介质或真空中浓度非常低时才相当稳定。",
    "(more precisely, a": "（更准确地说，一个",
    "A compound is a group of two or more elements": "化合物是两个或多个元素的集合",
    "free radical": "自由基",
    "Free radical": "自由基",
    "Free radicals are very reactive, and bind to other atoms randomly to create molecules.": "自由基非常活跃，可以随机地与其他原子结合形成分子。",
    "Gather 100 million (1e8) O.\n": "收集 1 亿 (1e8) O.\n",
    "In chemistry, a": "在化学中，一个",
    "radical": "激进的",
    "Unstable compound": "不稳定的化合物",
    "Unstable compounds decay to produce other atoms, like radioactivity. Unlike radioactivity, it doesn't produce energy as a product.": "不稳定的化合物会衰变产生其他原子，例如放射性。 与放射性不同，它不产生能量作为产品。",
    "Unstable means it is highly reactive, and can condense, decompose, polymerize, or become self-reactive quite easily due to pressure or temperature": "不稳定意味着它具有很高的反应性，并且很容易因压力或温度而冷凝、分解、聚合或发生自反应",
    "Free radical II": "自由基 II",
    "Generate 1 million (1e6) H2O. Check the Encyclopedia for a message.\n": "生成 100 万（1e6）H2O。 检查百科全书是否有消息。\n",
    "  The end ": "终点",
    "": "",
    "": "",
    "": "",
